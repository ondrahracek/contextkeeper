...
**Linux:**
```bash
curl -L https://github.com/ondrahracek/contextkeeper/releases/download/v0.3.0/contextkeeper-linux-amd64.tar.gz -o ck.tar.gz
tar -xzf ck.tar.gz
...
**macOS:**
```bash
curl -L https://github.com/ondrahracek/contextkeeper/releases/download/v0.3.0/contextkeeper-darwin-arm64.tar.gz -o ck.tar.gz
tar -xzf ck.tar.gz
...
Invoke-WebRequest -Uri "https://github.com/ondrahracek/contextkeeper/releases/download/v0.3.0/contextkeeper-windows-amd64.tar.gz" -OutFile ck.tar.gz
tar -xf ck.tar.gz
```
