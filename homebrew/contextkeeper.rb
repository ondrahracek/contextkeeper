...
class Contextkeeper < Formula
  desc "A minimalist CLI tool for managing project context across multiple devices"
  homepage "https://github.com/ondrahracek/contextkeeper"
  url "https://github.com/ondrahracek/contextkeeper/releases/download/v0.1.0/contextkeeper-0.1.0-src.tar.gz"
